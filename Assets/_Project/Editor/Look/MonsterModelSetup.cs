...
namespace SunkCost.Editor.Look
{
    ...
    public static class MonsterModelSetup
    {
        ...
        private static readonly CreaturePose[] Loops = { CreaturePose.Idle, CreaturePose.Drawn, CreaturePose.Hunting, CreaturePose.Frozen, CreaturePose.Rushing, CreaturePose.Fleeing, CreaturePose.Grabbing, CreaturePose.Aiming };
