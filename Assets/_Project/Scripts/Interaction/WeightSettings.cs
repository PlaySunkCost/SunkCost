...
namespace SunkCost.Interaction
{
    ...
    public sealed class WeightSettings : ScriptableObject
    {
        ...
        public float OverloadSpeedFactor => overloadSpeedFactor;
        ...
        public float SpeedFactor(float totalMassKg) => WeightMath.SpeedFactor(totalMassKg, capacityKg, minSpeedFactor, overloadSpeedFactor);
        ...
        public bool IsValid =>
            ...
            float.IsFinite(overloadSpeedFactor) && overloadSpeedFactor > 0f && overloadSpeedFactor <= 1f &&
