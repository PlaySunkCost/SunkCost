...
to the HQ — a railed bridge off the west rim and a short flight of stairs down
to the stern of a big ship (its deck 2.5 m under the platform's, 9.5 m over
the water), the stair's foot level with the deck (Dan: "the bridge connected to
