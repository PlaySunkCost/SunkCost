...
| The way aboard from the HQ | The ship's stair came off on 23 September 2026 (Dan: no stairs on the ship). At the rig the bridge lands at the tower's aft face, 6 m over the deck, with no way down but a jump: about 2.3 m onto the tower model's roof (about 3.7 m over the deck), then the rest (the HQ scene re-moored for the 48 m ship on 23 September 2026). Dan wants a fixed place on the HQ - a bridge the crew walks from the ship to the HQ - and maybe the HQ lower; meanwhile the boarding point (where Unstuck puts you) is `ShipStubBuilder.UnstuckPoint`, (-1.5, 0, -8) on open deck (23 September 2026, the ship audit's SHIP-001). | M | Dan, 23 September 2026: "do it later". Blocks the cabin matrix's boarding rows until done. |
